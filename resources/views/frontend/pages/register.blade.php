  ...
  <div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100">
        ...
        <form class="login100-form validate-form" id="register" method="post" action="{{ URL::to('/store') }}">
          {{ csrf_field() }}

          <div class="wrap-input100 validate-input m-b-26" data-validate="Name is required">
            <span class="label-input100">Name<font style="color:rgb(255,0,0);">*</font><font style="color:white">........</font></span>
          ...
          <div class="flex-sb-m w-full p-b-30">
            ...
            <div>
              <a href="{{URL::to('/login')}}">
                Click here to <font style="color:orange">Login!</font>
              </a>
            </div>
          </div>
