			...
			<div class="row">
				...
				<div class="col-lg-3 footer_col">
					...
					<div class="footer_contact_form_container">
						<form id="footer_contact_form" class="footer_contact_form" action="{{URL::to('/postcontact')}}" method="post">{{csrf_field()}}
				...
				<div class="col-lg-3 footer_col">
					...
					<ul class="contact_info_list">
						<li class="contact_info_item d-flex flex-row">
							...
							<div class="contact_info_text">4127 Kotowali 45b-c Patharghata</div>
						</li>
						<li class="contact_info_item d-flex flex-row">
						...
						<li class="contact_info_item d-flex flex-row">
							...
							<div class="contact_info_text"><a href="mailto:contactme@gmail.com?Subject=Hello" target="_top">ronisaharatul@gmail.com</a></div>
						</li>
						<li class="contact_info_item d-flex flex-row">
							<div><div class="contact_info_icon"><img src="images/planet-earth.svg" alt=""></div></div>
							<div class="contact_info_text"><a href="/home">www.vashavara.com</a></div>
						</li>
					</ul>
				</div>
