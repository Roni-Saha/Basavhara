...
<div id="demo" class="featured" >
	<div class="container">
           	...
           	<div class="row">
				<div class="col">
					<div class="section_title text-center">
						<h3 style="color: white">Bachelor House</h3>
        ...
        <div   class="row featured_row" >
					...
					<div  id="{{ $value->id }}" class="featured_card_container">
						<div class="card featured_card trans_300">
							...
							<div class="card-body">
								...
								<div class="rooms">
									...
									<div class="room">
										...
										<div class="room_content">
											...
											<span class="room_number">{{ $value->attacbathhroom }}</span>
										</div>
									</div>
								...
								<div class="room_tags">
									<span class="room_tag"><a href="detailbachelor/{{ $value->id }}" ><b>Details</b></a></span>
			...
			<br><br><br>
			<!-- paging -->
            <div style="margin-left: 480px; color: white">{{$viewbachelor->links()}}</div>
