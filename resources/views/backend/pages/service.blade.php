  ...
  <div class="modal-content">
    ...
    <p>Are you want to delete <b> {{ $value->catagory }}</b> message?</p>
     ...
     <div class="modal-footer">
          <a href="{{ URL::to('deleteservice/'.$value->id) }}" class="btn btn-primary">Yes</a>
...
window.onclick = function(event) {
  if (event.target == modal) {
    modal.style.display = "none";
        ...
        ||<a href="serviceupdate/{{$value->id}}" class="btn btn-success">Edit</a>

        ||<a data-toggle="modal" href="servicedetail/{{$value->id}}" class="btn btn-primary" href="" >Details</a>
